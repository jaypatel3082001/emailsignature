...
function BackendSidebar() {
 ...
 console.log("hhhhhhhhhhh bbbbbbbbbbbbbbbbb",userid)
  return (
    <>
        <div className='flex'>
...
<Link to={`/users/${userid}/emailuserdetails`}><button className='py-5 px-3 w-full flex ' ><svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv" height="23px" width="23px" focusable="false" fill='currentcolor' aria-hidden="true" viewBox="0 0 24 24" data-testid="NotesIcon"><path d="M3 18h12v-2H3v2zM3 6v2h18V6H3zm0 7h18v-2H3v2z"></path></svg><span className='ml-3'>Editor</span></button></Link>
